...
export default function OpportunitiesCarousel() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-12 bg-[#1ABC9C]">
  {/* 📌 Contenido a la izquierda */}
  <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-24 items-center z-40">
    ...
    <div className="relative w-[400px] h-[400px] flex items-center justify-center">
      {cards.map((card, index) => {
        ...
        return (
          <motion.div
            ...
            className={`absolute w-[320px] h-[400px] rounded-lg shadow-xl overflow-hidden cursor-pointer`}
      ...
      <button
        onClick={prevCard}
        className="absolute left-[-40px] bg-white p-2 rounded-full shadow-md hover:bg-gray-200 transition-all"
      >
        ◀
      </button>
      <button
        onClick={nextCard}
        className="absolute right-[-40px] bg-white p-2 rounded-full shadow-md hover:bg-gray-200 transition-all"
      >
        ▶
      </button>
    </div>
